...
var toEntries = (input) => input instanceof Map ? [...input] : Object.entries(input);
var fromEntries = (input, entries) => input instanceof Map ? new Map(entries) : Object.fromEntries(entries);
async function pProps(input, mapper = ((value) => value), options) {
...
async function pPropsAllSettled(input, mapper, options) {
  const entries = toEntries(input);
...
//# sourceMappingURL=p-props.js.map
