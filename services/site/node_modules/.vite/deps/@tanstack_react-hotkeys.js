...
var require_use_sync_external_store_shim_development = __commonJS({
  "../../node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React2 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState = React2.useState, useEffect4 = React2.useEffect, useLayoutEffect = React2.useLayoutEffect, useDebugValue = React2.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "../../node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React2 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef4 = React2.useRef, useEffect4 = React2.useEffect, useMemo2 = React2.useMemo, useDebugValue = React2.useDebugValue;
...
// ../../node_modules/@tanstack/react-hotkeys/dist/HotkeysProvider.js
...
function HotkeysProvider({ children, defaultOptions = DEFAULT_OPTIONS }) {
  ...
  return import_react.default.createElement(HotkeysContext.Provider, { value: contextValue }, children);
}
...
// ../../node_modules/@tanstack/hotkeys/dist/constants.js
...
var MODIFIER_KEYS = new Set(MODIFIER_ORDER);
...
var LETTER_KEYS = /* @__PURE__ */ new Set([
  "A",
  "B",
  "C",
  "D",
...
var PUNCTUATION_KEYS = /* @__PURE__ */ new Set([
  "/",
  "[",
  "]",
  "\\",
...
function isSingleLetterKey(key) {
  return new RegExp("^\\p{Letter}$", "u").test(key);
}
...
var STANDARD_MODIFIER_LABELS = {
  Control: "Ctrl",
  Alt: "Alt",
  Shift: "Shift",
  Meta: "Win"
};
var KEY_DISPLAY_SYMBOLS = {
  ArrowUp: "↑",
  ArrowDown: "↓",
  ArrowLeft: "←",
  ArrowRight: "→",
...
// ../../node_modules/@tanstack/hotkeys/dist/parse.js
...
// ../../node_modules/@tanstack/hotkeys/dist/format.js
...
function formatKeyForDebuggingDisplay(key, options = {}) {
  ...
  if (modLabel) {
    if (platform === "mac") {
      const symbol2 = MAC_MODIFIER_SYMBOLS[key];
      if (symbol2) return `${symbol2} ${modLabel}`;
    }
    return modLabel;
  }
...
// ../../node_modules/@tanstack/hotkeys/dist/match.js
...
// ../../node_modules/@tanstack/hotkeys/dist/manager.utils.js
...
var HotkeyManager = class HotkeyManager2 {
  ...
  */
  static getInstance() {
    if (!HotkeyManager2.#instance) HotkeyManager2.#instance = new HotkeyManager2();
    return HotkeyManager2.#instance;
  }
  /**
  * Resets the singleton instance. Useful for testing.
  */
  static resetInstance() {
    if (HotkeyManager2.#instance) {
      HotkeyManager2.#instance.destroy();
      HotkeyManager2.#instance = null;
    }
  }
  /**
  ...
  */
  register(hotkey, callback, options = {}) {
    ...
    if (conflictingRegistration) handleConflict(conflictingRegistration.id, hotkeyStr, conflictBehavior, (id2) => this.#unregister(id2));
...
var KeyStateTracker = class KeyStateTracker2 {
  static #instance = null;
  ...
  */
  static getInstance() {
    if (!KeyStateTracker2.#instance) KeyStateTracker2.#instance = new KeyStateTracker2();
    return KeyStateTracker2.#instance;
  }
  /**
  * Resets the singleton instance. Useful for testing.
  */
  static resetInstance() {
    if (KeyStateTracker2.#instance) {
      KeyStateTracker2.#instance.destroy();
      KeyStateTracker2.#instance = null;
    }
  }
  /**
...
// ../../node_modules/@tanstack/hotkeys/dist/recorder.js
...
var SequenceManager = class SequenceManager2 {
  static #instance = null;
  ...
  */
  static getInstance() {
    if (!SequenceManager2.#instance) SequenceManager2.#instance = new SequenceManager2();
    return SequenceManager2.#instance;
  }
  /**
  * Resets the singleton instance. Useful for testing.
  */
  static resetInstance() {
    if (SequenceManager2.#instance) {
      SequenceManager2.#instance.destroy();
      SequenceManager2.#instance = null;
    }
  }
  /**
...
// ../../node_modules/@tanstack/hotkeys/dist/validate.js
...
// ../../node_modules/@tanstack/react-hotkeys/dist/useHotkey.js
...
function useHotkey(hotkey, callback, options = {}) {
  ...
  const registrationRef = (0, import_react2.useRef)(null);
  const callbackRef = (0, import_react2.useRef)(callback);
  const optionsRef = (0, import_react2.useRef)(mergedOptions);
  const managerRef = (0, import_react2.useRef)(manager);
  callbackRef.current = callback;
  optionsRef.current = mergedOptions;
  managerRef.current = manager;
  const prevTargetRef = (0, import_react2.useRef)(null);
  const prevHotkeyRef = (0, import_react2.useRef)(null);
...
function useStore(atom, selector, compare = defaultCompare) {
  ...
  const boundGetSnapshot = (0, import_react3.useCallback)(() => atom?.get(), [atom]);
...
// ../../node_modules/@tanstack/react-hotkeys/dist/useHeldKeys.js
function useHeldKeys() {
  return useStore(getKeyStateTracker().store, (state) => state.heldKeys);
}

// ../../node_modules/@tanstack/react-hotkeys/dist/useHeldKeyCodes.js
function useHeldKeyCodes() {
  return useStore(getKeyStateTracker().store, (state) => state.heldCodes);
}

// ../../node_modules/@tanstack/react-hotkeys/dist/useKeyHold.js
...
// ../../node_modules/@tanstack/react-hotkeys/dist/useHotkeySequence.js
...
function useHotkeySequence(sequence, callback, options = {}) {
  ...
  const registrationRef = (0, import_react4.useRef)(null);
  const callbackRef = (0, import_react4.useRef)(callback);
  const optionsRef = (0, import_react4.useRef)(mergedOptions);
  const managerRef = (0, import_react4.useRef)(manager);
  callbackRef.current = callback;
  optionsRef.current = mergedOptions;
  managerRef.current = manager;
  const prevTargetRef = (0, import_react4.useRef)(null);
  const prevSequenceRef = (0, import_react4.useRef)(null);
  const hotkeySequenceString = formatHotkeySequence(sequence);
  const { target: _target, ...optionsWithoutTarget } = mergedOptions;
  (0, import_react4.useEffect)(() => {
    if (sequence.length === 0) return;
    const resolvedTarget = isRef2(optionsRef.current.target) ? optionsRef.current.target.current : optionsRef.current.target ?? (typeof document !== "undefined" ? document : null);
    if (!resolvedTarget) return;
    const targetChanged = prevTargetRef.current !== null && prevTargetRef.current !== resolvedTarget;
...
// ../../node_modules/@tanstack/react-hotkeys/dist/useHotkeyRecorder.js
...
//# sourceMappingURL=@tanstack_react-hotkeys.js.map
