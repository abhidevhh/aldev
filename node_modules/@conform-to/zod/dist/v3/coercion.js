...
function createTypeCheckTransform(expectedType) {
  ...
  return v3.any().superRefine((value, ctx) => {
    if (!check(value)) {
      ctx.addIssue({
        code: 'invalid_type',
...
function coerceType(type, options) {
  ...
  if (coercion) {
    schema = v3.any().transform(coercion).pipe(target);
  } else if (target !== type) {
    schema = target;
    ...
    schema = v3.any().transform(value => {
      ...
      return [value];
    }).pipe(new v3.ZodArray(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, arrayDef), {}, {
    ...
    schema = v3.any().transform(value => {
      ...
      return value;
    }).pipe(new v3.ZodObject(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, objectDef), {}, {
    ...
    if (options.skipTransforms && (def.effect.type === 'transform' || def.effect.type === 'preprocess') || options.skipValidation && def.effect.type === 'refinement') {
      ...
      schema = new v3.ZodEffects(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
        schema: coerceType(def.schema, options)
      }));
    }
  } else if (def.typeName === 'ZodOptional') {
    var innerType = coerceType(def.innerType, options);
    var wrapped = new v3.ZodOptional(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
      innerType
    }));
    schema = options.stripEmptyValue ? v3.any().transform(options.stripEmptyValue).pipe(wrapped) : wrapped;
    ...
    if (options.skipDefaults) {
      ...
      var _wrapped = new v3.ZodDefault(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
        innerType: _innerType
      }));
      schema = options.stripEmptyValue ? v3.any().transform(options.stripEmptyValue).pipe(_wrapped) : _wrapped;
    }
  } else if (def.typeName === 'ZodCatch') {
    schema = new v3.ZodCatch(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
      innerType: coerceType(def.innerType, options)
    }));
  } else if (def.typeName === 'ZodIntersection') {
    schema = new v3.ZodIntersection(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
      left: coerceType(def.left, options),
      right: coerceType(def.right, options)
    }));
  } else if (def.typeName === 'ZodUnion') {
    schema = new v3.ZodUnion(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
    ...
    schema = v3.any().transform(value => {
      ...
      return value;
    }).pipe(new v3.ZodDiscriminatedUnion(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
      options: def.options.map(option => coerceType(option, options)),
    ...
    schema = new v3.ZodBranded(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
      type: coerceType(def.type, options)
    }));
  } else if (def.typeName === 'ZodTuple') {
    schema = new v3.ZodTuple(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
      items: def.items.map(item => coerceType(item, options))
    }));
  } else if (def.typeName === 'ZodNullable') {
    schema = new v3.ZodNullable(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
      innerType: coerceType(def.innerType, options)
    }));
    ...
    if (options.skipTransforms) {
      ...
      schema = new v3.ZodPipeline(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, def), {}, {
    ...
    schema = v3.lazy(() => coerceType(inner, options));
  }
  if (type !== schema) {
