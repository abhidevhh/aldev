...
function coerceType(type, options) {
  ...
  if (coercion) {
    schema = v4.pipe(v4.transform(coercion), target);
  } else if (target !== type) {
    schema = target;
    ...
    schema = options.stripEmptyValue ? v4.pipe(v4.transform(options.stripEmptyValue), wrapped) : wrapped;
    ...
    if (options.skipDefaults) {
      ...
      schema = options.stripEmptyValue ? v4.pipe(v4.transform(options.stripEmptyValue), _wrapped) : _wrapped;
    }
