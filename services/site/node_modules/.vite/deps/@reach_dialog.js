...
var FocusLock = React7.forwardRef(function FocusLockUI(props, parentRef) {
  ...
  return React7.createElement(React7.Fragment, null, hasLeadingGuards && [
    ...
    onDeactivation,
    returnFocus
  }), React7.createElement(Container, _extends({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
  ...
  return function wrap(WrappedComponent) {
    ...
    var SideEffect = (function(_PureComponent) {
      ...
      _proto.render = function render() {
        return import_react4.default.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
...
function MoveFocusInside(_ref2) {
  ...
  return React12.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !isDisabled), {
    ref,
    className
  }), children);
}
...
var RemoveScroll = React14.forwardRef(function(props, parentRef) {
  ...
  return React14.createElement(
    ...
    forwardProps ? React14.cloneElement(React14.Children.only(children), __assign2({}, containerProps, { ref: containerRef })) : React14.createElement(Container, __assign2({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
var ReactRemoveScroll = React18.forwardRef(function(props, ref) {
  return React18.createElement(RemoveScroll, __assign2({}, props, { ref, sideCar: sidecar_default }));
});
...
function DialogWrapper({
  ...
  return React19.createElement(Portal, {
    ...
    ...props
  }, React19.createElement(DialogContextProvider, {
    isOpen
  }, children));
}
DialogWrapper.displayName = "unstable_DialogWrapper";
var DialogInner = React19.forwardRef(function DialogInner2({
  allowPinchZoom,
  as: Comp = "div",
  ...
  const overlayNode = React19.useRef(null);
  const ref = useComposedRefs(overlayNode, forwardedRef);
  const activateFocusLock = React19.useCallback(() => {
  ...
  return React19.createElement(es2015_default2, {
    autoFocus: true,
    returnFocus: true,
...
var DialogOverlay = React19.forwardRef(function DialogOverlay2({ as: Comp = "div", isOpen = true, ...props }, forwardedRef) {
  return isOpen ? React19.createElement(DialogWrapper, {
    isOpen
  }, React19.createElement(DialogInner, {
...
var DialogContent = React19.forwardRef(function DialogContent2({ as: Comp = "div", onClick, onKeyDown, ...props }, forwardedRef) {
  let { isOpen } = useDialogContext("DialogContent");
  return React19.createElement(Comp, {
    "aria-modal": "true",
    role: "dialog",
    tabIndex: -1,
    ...props,
...
var Dialog = React19.forwardRef(function Dialog2({
  ...
  return React19.createElement(DialogOverlay, {
    allowPinchZoom,
    initialFocusRef,
    isOpen,
    onDismiss
  }, React19.createElement(DialogContent, {
    ref: forwardedRef,
    ...props
  }));
});
