...
describe('jsx page content utils', () => {
	test('parseSitemapPathnames extracts and normalizes loc entries', () => {
      ...
      <urlset>
        <url><loc>https://abhidev.com/about</loc></url>
        <url><loc>https://abhidev.com/about/</loc></url>
        <url><loc>https://abhidev.com/blog?source=sitemap</loc></url>
	...
	test('extractRenderedPageContent removes nav/footer/script noise', () => {
      ...
      <html>
        ...
        <body>
          ...
          <section>
            <h1>About AbhiDev</h1>
            <p>AbhiDev builds and teaches AI-powered full-stack systems.</p>
          </section>
          <main>
            <h2>Main content</h2>
    ...
    `
		...
		expect(extracted.title).toBe('About AbhiDev')
		expect(extracted.text).toContain('About AbhiDev')
